...
const typed =new Typed('.multiple-text',{
    strings: ['Software Engineer !','Frontend Developer !', 'Database Administrator !','Backend Developer !','Web Designer !','Graphic Designer!','Video Editor!'],
    typeSpeed: 60,
    backSpeed: 20,
    backDelay:1500,
    loop: true
...
form.addEventListener("submit", function (event) {
  ...
  xhr.open("POST", "https://formspree.io/f/xanwoaqg", true);
